...
const a = "js--", r = {
  ...
  TAB: `${a}tab`,
  PANEL: `${a}panel`,
  TABS_WRAPPER: `${a}tabs-wrapper`,
  TAB_LIST: `${a}tab-list`,
  PANEL_LIST: `${a}panel-list`,
  BUTTON: `${a}pagination-button`,
  CURRENT: `${a}pagination-current`,
  EMPTY_PLACE: `${a}pagination-empty-place`
};
class g {
  constructor(t = '[data-pagination="wrapper"]', { paginationWrapperSelector: e = '[data-pagination="container"]', dynamicElementSelector: s = '.w-dyn-item[role="listitem"]', previousButtonInner: n = "Prev", nextButtonInner: o = "Next", itemsPerPage: l, hiddenButtons: u = {
    min: 6
  } }) {
    i(this, "component");
    ...
    i(this, "createButtonsMap", () => {
      const t = [], e = new Array(this.totalPages).fill("").map((n, o) => o + 1), s = (n) => n === 1 || n === this.totalPages || n >= this.currentPage - 1 && n <= this.currentPage + 1;
      e.forEach((n, o) => {
        const l = {
          page: n,
          current: o + 1 === this.currentPage
        };
        s(n) || this.buttons.length < this.hiddenButtons.min ? t.push({
          ...l,
          visible: !0
        }) : s(e[o + 1]) && s(e[o - 1]) ? t.push({
          ...l,
          visible: !0
        }) : t.push({
          ...l,
    ...
    i(this, "addCustomButtons", () => {
      this.totalPages > 1 ? (this.paginationWrapper.classList.remove(r.UNACTIVE), this.addButton({
        label: "Prev page",
      ...
      })) : this.paginationWrapper.classList.add(r.UNACTIVE), this.createButtonsMap(), this.updateButtonsAttrs(), this.addRelLinks();
    });
    i(this, "addButton", ({ content: t, label: e }) => {
      const s = document.createElement("button");
      s.innerHTML = t, s.classList.add(r.BUTTON), s.setAttribute("aria-label", e), s.setAttribute("type", "button"), e === "Prev page" ? this.prevButton = s : e === "Next page" ? this.nextButton = s : this.buttons.push(s), this.paginationWrapper.append(s);
    });
    i(this, "updateButtonsAttrs", () => {
      this.currentPage === 1 ? this.makeDisable(this.prevButton) : this.makeEnable(this.prevButton), this.currentPage === this.totalPages ? this.makeDisable(this.nextButton) : this.makeEnable(this.nextButton), this.buttons.forEach((t, e) => {
        ...
        e + 1 === this.currentPage ? t.classList.add(r.CURRENT) : t.classList.remove(r.CURRENT), !s.visible || s.current ? this.makeDisable(t) : this.makeEnable(t), s.visible ? (t.classList.remove(r.EMPTY_PLACE), t.textContent = s.page) : (t.classList.add(r.EMPTY_PLACE), t.textContent = this.emptyMapInner), s.current ? t.classList.add(r.CURRENT) : t.classList.remove(r.CURRENT);
      });
    });
    ...
    i(this, "goToCurrent", () => {
      this.dynamicElements.forEach((t, e) => {
        Math.ceil((e + 1) / this.itemsPerPage) === this.currentPage ? (t.removeAttribute("style"), t.removeAttribute("inert")) : (t.style.display = "none", t.setAttribute("inert", "true"));
    ...
    this.component = typeof t == "string" ? document.querySelector(t) : t, this.paginationWrapperSelector = e, this.paginationWrapper = void 0, this.dynamicElementSelector = s, this.dynamicElements = [], this.previousButtonInner = n, this.nextButtonInner = o, this.itemsPerPage = l, this.url = new URL(window.location.href), this.currentPage = 1, this.totalPages = 1, this.buttons = [], this.prevButton = void 0, this.nextButton = void 0, this.buttonsMap = [], this.emptyMapInner = "...", this.hiddenButtons = u, this.init();
  }
}
export {
  g as Pagination
